# nvim-treesitter-queries-eds

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-eds/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-eds/actions/workflows/validate.yml)

Neovim tree-sitter queries for **eds**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-eds",
...
- [ ] Changes are scoped to `eds` — do not include files for other languages
